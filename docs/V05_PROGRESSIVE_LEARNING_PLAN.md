...
> 状态：P0–P2 第三批已实现（Day 1–4）；Day 5–7 待后续迭代
> 版本建议：`v0.5.0-beta.1`
> 核心目标：让第一次使用者先理解、再模仿、再独立表达，最终完成一次可复核的结构化汇报项目。

当前实现证据：

- `/training-demo`：七天课程地图、Day 1–4、顺序解锁和刷新恢复；
- `/training-demo/classic`：保留 v0.4 无提示水平检查；
- 33 个 Vitest 文件、462 项测试和 22 条桌面/移动端 Playwright 流程通过；
- v0.4 的 180 条规则评测与 54 条合成轨迹继续通过；
- 当前实现仍不等于七天课程、毕业项目或真实用户价值已经完成验证。
...
| Day 5 | 把信息整理成两到三点 | 信息卡分组、命名分组、短答 | 部分支架 | 3–4 句 |
