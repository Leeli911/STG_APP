...
Status: **P0–P2 第五批开发中，目标版本 `v0.5.0-beta.1`；Day 1–6 已实现，Day 7 待开发**
...
- Day 1–6 已具备顺序解锁、本地进度、刷新恢复、失败提示和桌面/移动端 E2E。
...
1. 冻结 Day 7 毕业项目与未见迁移题，完成七天课程。
2. 增加“继续上次训练”的首屏恢复入口和七天完成摘要，减少回访用户寻找成本。
3. 完整七天可用后执行 7–14 天开发者自测，再决定语音输入和规则同义词扩展的优先级。

详细范围见 [v0.5 渐进式学习与项目制训练方案](V05_PROGRESSIVE_LEARNING_PLAN.md) 与 [Day 1–6 用户旅程会审](V05_USER_JOURNEY_REVIEW_2026-08-04.md)。
