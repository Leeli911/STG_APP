...
Status: **P0–P2 第二批开发中，目标版本 `v0.5.0-beta.1`；Day 1–3 已实现，Day 4–7 待开发**
...
- Day 1–3 已具备顺序解锁、本地进度、刷新恢复、失败提示和桌面/移动端 E2E。
- Day 3 已实现首句识别、可键盘操作的句子排序、结论先行开放短答和针对性支架。
- `/training-demo/classic` 保留 v0.4 冷答与可信评测闭环作为有基础用户的水平检查。

下一优先级：

1. 实现 Day 4 的“结论＋一个理由”与支架渐隐。
2. 实现 Day 5 信息卡分组和开放两到三点短答。
3. 组合 Day 6 完整汇报，并冻结 Day 7 毕业项目与未见迁移题。
4. 完整七天可用后执行 7–14 天开发者自测，再决定语音输入优先级。
